...
function Gardentools() {
  ...
  return (
    <div className="container-fluid p-4">
      <h2 className="text-center mb-4">Flower seeds</h2>
      <p>
        🌸 "Flower seeds are nature's promise of beauty, carrying the potential to bloom into vibrant petals, fragrances, and colors—from delicate pansies to bold sunflowers."
      </p>
