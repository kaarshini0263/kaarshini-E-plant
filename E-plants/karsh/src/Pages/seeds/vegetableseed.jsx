...
function Vegetableseeds() {
  ...
  return (
    <div className="container-fluid p-4">
      <h2 className="text-center mb-4">Vegetable seed</h2>
      <p>
        🌱 "Vegetable seeds are compact bundles of future harvests, offering everything from crunchy carrots to juicy tomatoes—each with unique growth needs and seasons."
      </p>
