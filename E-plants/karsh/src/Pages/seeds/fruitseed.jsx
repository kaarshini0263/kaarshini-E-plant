...
function Fruitseeds() {
  ...
  return (
    <div className="container-fluid p-4">
      <h2 className="text-center mb-4">Fruit seeds</h2>
      <p>
        🌱 "Fruit seeds are nature's tiny powerhouses, containing the genetic blueprint to grow into full-bearing plants, offering endless varieties from sweet mangoes to crunchy apples."
      </p>
