...
function Organic() {
  ...
  return (
    <div className="container-fluid p-4">
      <h2 className="text-center mb-4">Organic Fertilizer</h2>
      <p>🌱 "Fertilizers provide essential nutrients (N-P-K) to plants, boosting growth, blooms, and yields—like a vitamin boost for healthier greenery,💡 "Organic options (compost, manure) improve soil long-term, while synthetic ones give quick results but require careful dosing to avoid burn."</p>
